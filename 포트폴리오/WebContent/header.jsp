...
<body>
	...
	<header>
		<div class="header">
			<nav class="mainMenu">
				<a href="MainPage.jsp"><img alt="logo" src="images/logo_black.png" width="200px" height="80px" class="headLogoImg"></a>
...
<!-- 로그인 창 -->
			<div class="login_sideBar">
				<div class="login">
					...
					<h1><a href="MainPage.jsp"><img alt="메인페이지로가는 로고 이미지" src="images/logo_black.png" width="200px" height="100px"></a></h1>
...
<!-- 아이디 / 비밀번호 찾기 팝업창 -->
		<div class="Login_Help_Page">
			...
			<a href="MainPage.jsp"><img src="images/logo_black.png" width="200" height="100"></a>
			<ul class="tab_title">
...
<!-- 회원가입 팝업 창 -->
		<div class="joinPage">
			...
			<a href="MainPage.jsp"><img alt="메인페이지로 가는 로고이미지" src="images/logo_black.png"></a>
